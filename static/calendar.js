...
Calendar.getAbsolutePos = function (I) {
    ...
    var H = {x: I.offsetLeft - G, y: I.offsetTop - J};
    if (I.offsetParent) {
    ...
    if (this.showsTime) {
        ...
        (function () {
            ...
            S.onSetTime = function () {
                var K, L = this.date.getHours(), J = this.date.getMinutes();
                if (A) {
                    K = (L >= 12);
                    if (K) {
                        L -= 12
...
Calendar._keyEvent = function (T) {
    ...
    var V = (Calendar.is_ie || T.type == "keypress"), S = T.keyCode;
    if (T.ctrlKey) {
        switch (S) {
            case 37:
...
Calendar.prototype._init = function (q, e) {
    var f = new Date(), l = f.getFullYear(), c = f.getMonth(), AB = f.getDate();
...
(function ($) {
    function TimeEntry() {
        ...
        this.regional = [];
        this.regional[''] = {show24Hours: true, separator: ':', ampmPrefix: '', ampmNames: ['AM', 'PM'], spinnerTexts: ['Now', 'Previous field', 'Next field', 'Increment', 'Decrement']};
        this._defaults = {appendText: '', showSeconds: true, timeSteps: [1, 1, 1], initialField: 0, noSeparatorEntry: false, useMouseWheel: true, defaultTime: null, minTime: null, maxTime: null, spinnerImage: 'spinnerDefault.png', spinnerSize: [20, 20, 8], spinnerBigImage: '', spinnerBigSize: [40, 40, 16], spinnerIncDecOnly: false, spinnerRepeat: [500, 250], beforeShow: null, beforeSetTime: null};
        $.extend(this._defaults, this.regional[''])
    }

    $.extend(TimeEntry.prototype, {markerClassName: 'hasTimeEntry', propertyName: 'timeEntry', _appendClass: 'timeEntry_append', _controlClass: 'timeEntry_control', _expandClass: 'timeEntry_expand', setDefaults: function (a) {
        ...
        var e = {options: $.extend({}, this._defaults, c), input: d, _field: 0, _selectedHour: 0, _selectedMinute: 0, _selectedSecond: 0};
